...
def run(
        weights=ROOT / 'weights/best_5s.pt',  # model.pt path(s)
        source=ROOT / 'data/images/0.jpg',  # file/dir/URL/glob, 0 for webcam
